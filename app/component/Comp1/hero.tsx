  ...
  return (
    <div className="main">
      <div className="parent">
        ...
        <div className="div2">
          <div className="g"  data-aos="fade-left"></div>
          <h1 className = " bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-5xl bg-opacity-10" data-aos="fade-left">
